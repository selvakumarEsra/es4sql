...
public class AggregationTest {
	...
	public void testSubAggregations() throws  Exception {
		...
		final String query = String.format("SELECT * FROM %s/account GROUP BY (gender, age), (state) LIMIT 0,10", TestsConstants.TEST_INDEX);
	...
	public void testSimpleSubAggregations() throws  Exception {
		final String query = String.format("SELECT * FROM %s/account GROUP BY (gender), (state) LIMIT 0,10", TestsConstants.TEST_INDEX);
